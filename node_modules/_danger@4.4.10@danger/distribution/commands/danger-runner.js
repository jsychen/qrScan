    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                foundDSL = true;
                dangerFile = file_utils_1.dangerfilePath(commander_1.default);
                return [4 /*yield*/, json_to_context_1.jsonToContext(jsonString, commander_1.default)];
            case 1:
                context = _a.sent();
